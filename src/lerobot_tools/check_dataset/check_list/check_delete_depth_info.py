...
def check_delete_depth_info_func(input_path, fix=False, allow_depth=False):
    """
    ...
    allow_depth : bool
        If True, allow depth information in the dataset.
    ...
    """
    if allow_depth:
        print("Depth information is allowed. Skipping check.")
        return True
...
if __name__ == "__main__":
    ...
    parser.add_argument("--allow-depth", action="store_true", help="Allow depth information in the dataset (skip check)")

    args = parser.parse_args()
    check_delete_depth_info_func(args.input_path, fix=args.fix, allow_depth=args.allow_depth)
